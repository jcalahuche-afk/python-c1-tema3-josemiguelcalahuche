...
def create_sample_data(session):
    ...
    author1 = Author(name="Gaston Leroux")
    author2 = Author(name="Stephen King")
    
    book1 = Book(title="El misterio del cuarto amarillo", year=1907, author_id=None)
    book2 = Book(title="Los Tommyknockers", year=1987, author_id=None)
    book3 = Book(title="El perfume de la dama de negro", year=1908, author_id=None)
